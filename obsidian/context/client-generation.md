...
3. `obsidian/client/client-generation-from-openspec.md`, `lister-editor-viewer-pattern.md`, `rxjs-service-pattern.md`, `etag-optimistic-concurrency-ui.md` — the framework-independent patterns every generated screen follows.
