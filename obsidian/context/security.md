...
1. `openspec/specs/backend-security/spec.md` — the current baseline (no authentication enforced) and the explicit statement that roles/JWT are not yet specified.
