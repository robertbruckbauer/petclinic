...
# Building — map of contents

Build, tooling, and CI/CD conventions spanning the Gradle multi-module build and both Node-based clients.

- [gradle-module-conventions.md](gradle-module-conventions.md) — module layout and the shared root build conventions.
