...
The entity class `Owner` extends `JsonJpaEntity` which provides unique identifier and version for optimistic locking.
...
The item class `OwnerItem` is a simplified representation of an _Owner_ for item selection purposes.
