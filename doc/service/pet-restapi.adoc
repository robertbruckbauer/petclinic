...
The entity class `Pet` extends `JsonJpaEntity` which provides unique identifier and version for optimistic locking.
...
The enum `Sex` indicates the sex of the animal.
