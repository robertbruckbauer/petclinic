...
This operation reports `Not Found` or code 404 when the `VERSION` resource is missing or cannot be read.

This operation reports `Bad Request` or code 400 when the `VERSION` resource content is syntactically invalid.
