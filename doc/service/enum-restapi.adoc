...
This operation creates a new entity for a discriminator.
...
This operation updates an existing entity for a discriminator and code.
Response is of type `Enum`.
...
This operation deletes a single persisted entity for a discriminator and code.
Response is of type `Enum`.
