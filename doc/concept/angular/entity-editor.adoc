...
The editor component is a standalone Angular component with reactive state management using signals for efficient state management and change detection.
...
`onSubmitClicked` creates a new version of the entity with editable properties of the editor.
...
Siehe xref:{relrootdir}/doc/concept/angular/entity-service.adoc[Entity Service] für mehr Informationen.
...
The Angular component is used internally.
