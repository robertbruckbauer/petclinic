...
[source,ts]
----
include::{includedir}/app/client-svelte/src/main/svelte/services/backend.service.ts[tags=restApiGetAll,indent=0]
----
...
[source,ts]
----
include::{includedir}/app/client-svelte/src/main/svelte/services/backend.service.ts[tags=restApiGet,indent=0]
----
...
[source,ts]
----
include::{includedir}/app/client-svelte/src/main/svelte/services/backend.service.ts[tags=restApiPost,indent=0]
----
...
[source,ts]
----
include::{includedir}/app/client-svelte/src/main/svelte/services/backend.service.ts[tags=restApiPut,indent=0]
----
...
[source,ts]
----
include::{includedir}/app/client-svelte/src/main/svelte/services/backend.service.ts[tags=restApiPatch,indent=0]
----
...
[source,typescript]
----
include::{includedir}/app/client-svelte/src/main/svelte/services/backend.service.ts[tags=restApiDelete,indent=0]
----
