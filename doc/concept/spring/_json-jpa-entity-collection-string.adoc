...
void patchApi<Entity><Name>() throws Exception {
    ...
    mockMvc.perform(patch("/api/<entity>/" + uuid)
            ...
            .andExpect(jsonPath("$.id")
                    .value(uuid.toString()))
            .andExpect(jsonPath("$.all<Name>") <2>
                    .isArray())
            .andExpect(jsonPath("$.all<Name>[0]")
                    .value("A"))
            .andExpect(jsonPath("$.all<Name>[1]")
                    .value("Z"))
            .andExpect(jsonPath("$.all<Name>[2]") <3>
                    .doesNotExist());
}
----

<1> Test for ordering of the collection elements.
<2> Test for collection type.
<3> Test for collection size.
