...
When running the application with the PostgreSQL database, an incremental schema migration is executed as a dedicated migration step before the backend server starts.
