...
class <Entity>Test {
    ...
    void equalsHashcodeToString() {
        ...
        // different objects
        final var other = createWithName(name.toUpperCase());
...
<2> Test for equality operations, at least for identical objects, same objects, different objects, null object and wrong type
<3> Test for serialization operations, using json path queries.
<4> Test for cloning.
