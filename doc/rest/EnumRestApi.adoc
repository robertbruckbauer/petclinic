...
Enumerations are organized by discriminator (art) for logical grouping (e.g., "SPECIES", "SKILL").
...
// TODO: Missing DELETE operation documentation - The EnumRestController implements
// DELETE /api/enum/{art}/{code} operation that should be documented here.
// Add section for DELETE operation with curl, request, and response examples.
