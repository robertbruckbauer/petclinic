...
This operation creates a new _Enum_ entity for an discriminator.
...
This operation updates an existing _Enum_ entity for an discriminator and code.
Response is of type _EnumItem_.
...
This operation returns all persisted _Enum_ entities for an discriminator ordered by code.
...
This operation deletes a single persisted _Enum_ entity for an discriminator and code.
Response is of type _EnumItem_.
