...
NOTE: Document the address and contact PATCH operations with separate examples. Check if snippets exist for patch-api-owner-address and patch-api-owner-contact.
