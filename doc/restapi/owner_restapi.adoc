...
This operation reports `Conflict` or code 409 if the name already exists or data is incomplete.
...
TIP: The description of attributes other than name are omitted for simplicity because they are following the same pattern.
