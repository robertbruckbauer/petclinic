...
The agent reviews all related implementation files and ensures all REST API documentation are up-to-date, fixes minor issues or leaves hints and instructions to fix issues.
