...
The service uses a central configuration file for the database.
It is only read when the application starts.

.database.properties
[source,text]
----
include::{project-dir}/lib/backend-data/src/main/resources/database.properties[]
----
...
[source,text]
----
include::{project-dir}/lib/backend-data/src/main/resources/liquibase/changelog.xml[]
----
